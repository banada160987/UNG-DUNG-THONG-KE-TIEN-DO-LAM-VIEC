...
export const generateBusWordReport = async (allStudents, parkingData, busData) => {
  // --- 1. PREPARE DATA ---
  ...
  parkingData.forEach(p => {
    ...
    if (vehicleStats[vType] !== undefined) {
      ...
      vehicleStats['Đưa đón 2 chiều']++;
    } else if (vType && vType.includes('50cc')) {
      vehicleStats['Đưa đón 1 chiều']++;
    } else {
      vehicleStats['Khác']++;
    }
  });
    ...
    sections: [
      {
        ...
        children: [
          ...
          createTable(
            ...
            [
              ["Đưa đón 2 chiều", vehicleStats['Đưa đón 2 chiều'], totalSchoolStudents > 0 ? ((vehicleStats['Đưa đón 2 chiều'] / totalSchoolStudents) * 100).toFixed(1) : 0],
              ["Đưa đón 1 chiều", vehicleStats['Đưa đón 1 chiều'], totalSchoolStudents > 0 ? ((vehicleStats['Đưa đón 1 chiều'] / totalSchoolStudents) * 100).toFixed(1) : 0],
          ...
          createParagraph(`- Số lượng học sinh sử dụng xe máy điện: ${vehicleStats['Đưa đón 2 chiều']} học sinh.`),
          createParagraph(`- Số lượng học sinh sử dụng xe máy 50cc: ${vehicleStats['Đưa đón 1 chiều']} học sinh.`),
